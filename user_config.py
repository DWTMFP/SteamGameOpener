'''
if you messed up something, make sure, that the variables have the correct name and make sure, that you didn't create " where they are not needed or didn't, when they were.
'''
...
HEIGHT_SCROLLBAR = 600 #std 600; It's the height of the Scrollbar in Pixels
